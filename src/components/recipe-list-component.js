                  ...
                  <div className="container">
                      <div className="row row-30">
                        ...
                        <div className="caviar-portfolio clearfix">
                            <div className="single_menu_item breakfast wow fadeInUp">
                            ...
                            <div className="single_menu_item lunch wow fadeInUp">
                                <div className="d-sm-flex align-items-center">
                                    <div className="dish-thumb">
                            ...
                            <div className="single_menu_item dinner wow fadeInUp">
                                <div className="d-sm-flex align-items-center">
                                    <div className="dish-thumb">
